      ...
      if (result.isDenied) {
        ...
        try {
          ...
          if (response.ok) {
            ...
            await queryClient.prefetchQuery('get-all-body-profile');
          }
          else {
...
// const UpdateModal = ({ isOpen, loading, isClose }) => {
...
//   console.log('getBodyAttributesDetail:', getBodyAttributesDetail)
